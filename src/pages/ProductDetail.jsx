          ...
          <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-2">
                {shades.map((shade) => (
                  <button
                    ...
                    className={`flex items-center space-x-2 px-3 py-2 rounded-lg border-2 text-sm ${
                  ...
                  >
                    <div className={`w-4 h-4 rounded-full ${shade.color}`}></div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                >
                  Add to Shopping Bag - ${(product.price * quantity).toFixed(2)}
                </Button>
                <Button
                  variant="outline"
                  size="large"
            ...
            <div className="border-t border-gray-200 pt-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="text-gray-600 ml-2">GLM{product.id.toString().padStart(4, '0')}</span>
                </div>
                <div>
