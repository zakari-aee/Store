                ...
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                            Discover our carefully curated collection organized to help you find exactly what you need
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
                        {categories.map((category, index) => {
                            ...
                            return (
                                ...
                                >
                                    <Card className="p-6 border border-gray-100 bg-white hover:border-rose-200 hover:shadow-xl transition-all duration-300 h-full relative overflow-hidden">
                                        {/* Background Pattern */}
                                        ...
                                        <div className={`w-16 h-16 ${category.bgColor} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}>
                                            <IconComponent size={28} className={category.iconColor} />
                                        </div>

                                        {/* Content */}
                                        <div className="text-center">
                                            <h3 className="font-semibold text-gray-900 mb-2 group-hover:text-rose-600 transition-colors text-lg">
                                                {category.name}
                                            </h3>
                    ...
                    <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 text-center max-w-4xl mx-auto">
                        ...
                        <div className="p-4">
                            <div className="text-2xl font-bold text-rose-600 mb-1">500+</div>
                            <div className="text-gray-600 text-sm">Products</div>
                        </div>
                        <div className="p-4">
                            <div className="text-2xl font-bold text-rose-600 mb-1">10K+</div>
